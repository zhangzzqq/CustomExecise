...
public class ResolutionListPopWindow extends PopupWindow {
    ...
    public ResolutionListPopWindow(final Activity context, String[] resolution, final OnItemClickListener listener) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        contentView = inflater.inflate(R.layout.pop_window_resolutionlist, null);
